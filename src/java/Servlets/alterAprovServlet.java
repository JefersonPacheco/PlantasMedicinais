...
@WebServlet(name = "alterAprovServlet", urlPatterns = {"/alterAprovServlet"})
public class alterAprovServlet extends HttpServlet {
     ...
     */
    String pagina = "avaliaPlanta.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if(!fileName.equals(""))
                    planta.setLocal(local+fileName);
                else
...
//            }
            ...
            if (controllerValidarPlanta(request, response, planta) == true)
            {
                try {
                    ...
                    if(controllerAlterarPlanta(request, response, planta) == true){
                        ...
                        String msg = "Planta " + planta.getNomePopular()+ " alterada e aprovada com sucesso!";
    ...
    protected boolean controllerAlterarPlanta(HttpServletRequest request, HttpServletResponse response, Planta planta) throws ServletException, IOException, SQLException
    {
        ...
        if(dao.alterarPlanta(planta, sintomas, regioes, partesPlanta) == true){
            dao2.aprovarPlanta(planta.getId(), planta.getIdResponsável());   // altera o status e coloca o professor que aprovou
            return true;
        }
        else
        {
