<%-- 
    Document   : plantasPendentes
    Created on : 26/02/2018, 17:17:26
...
<head>
    ...
    <%
        ...
        if(!ses2.getAttribute("perfil").equals("Assistente")){                               // verifica se o usuário não é Professor
    ...
    <link href="assets/css/font-awesome.css" rel="stylesheet" />
     <!-- MORRIS CHART STYLES-->
    <title>Plantas Medicinais Pendentes</title>
...
<body onload="javascript:history.replaceState(null, null, 'plantasPendentes.jsp')">  
    <div id="wrapper">
...
font-size: 16px;">  
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <center><h2>Plantas Medicinais Pendentes de Avaliação</h2></center>
                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach var="u" items="${dao.consultarPlantaReprovada()}">
                                        <tr class="odd gradeX">
                                            <td>${u.nomePopular}</td>
                                            <td>${u.nomeCientifico}</td>
                                            <td>${u.principioAtivo}</td>
                                            <td><b><i>${u.status}</i></b></td>
                                            <td><a href='PlantaServlet?id=${u.id}&pagina=editar2'><button type="submit" class="btn btn-primary">Editar</button></a>
                                                <a href='PlantaServlet?id=${u.id}&pagina=excluir2' class="confirm"><button type="submit" class="btn btn-danger">Excluir</button></a>
                                            </td>
                                        </tr>
